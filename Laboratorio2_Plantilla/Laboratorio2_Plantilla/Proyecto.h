...
public:
	...
	void agregarComponente(Actividad_Grupo* componenentePadre, Cmpnte_Proyecto* componenteHijo); //
	void eliminarComponente(Cmpnte_Proyecto* componentePorBorrar); //
	Cmpnte_Proyecto* getComponente()
